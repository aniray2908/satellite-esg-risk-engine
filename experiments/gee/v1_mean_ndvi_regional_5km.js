...
// Version: v1
// Purpose: Regional coordinate, 5km buffer
// Metric: Mean NDVI (Jan–Mar seasonal)
// Key Learning: Forest dominance masks mining signal
// ==========================================
...
Map.addLayer(buffer, {color: 'red'}, '5km Buffer');
...
print('v1 — Mean NDVI (5km, Jan–Mar):', results);
