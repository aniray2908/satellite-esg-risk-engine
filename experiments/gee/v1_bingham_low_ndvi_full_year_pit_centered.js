...
var point = ee.Geometry.Point([-112.1360954284668, 40.53226525841381]);
...
print('Bingham Canyon — Full-Year Metrics (2019–2023):', results);

Export.table.toDrive({
  collection: results,
  description: 'bingham_pit_centered_full_year_v1',
  fileFormat: 'CSV'
});
